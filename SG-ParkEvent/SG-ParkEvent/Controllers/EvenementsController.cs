...
namespace SG_ParkEvent.Controllers
{
    public class EvenementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nom,Lieu,DateHeure,Duree,Theme,Descriptif, Client")] Evenement evenement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nom,Lieu,DateHeure,Duree,Theme,Descriptif, Client")] Evenement evenement)
        {
            if (ModelState.IsValid)
            {
