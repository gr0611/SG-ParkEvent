...
namespace SG_ParkEvent.Controllers
{
    public class EvenementsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nom,Lieu,DateHeure,Duree,Theme,Descriptif")] Evenement evenement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nom,Lieu,DateHeure,Duree,Theme,Descriptif")] Evenement evenement)
        {
            if (ModelState.IsValid)
            {
